                ...
                var code = function()
                    {
                        ...
                        if (p.direction == 'left')
                        {
                            ...
                            if (strMove.width() > strWrap.width())
                            {
                                ...
                                if (p.xml)
                                {
                                    strMove.css({ left: strWrap.width() })
                                }
                                    ...
                                    if (p.drag)
                                    {
                                        strWrap.on('mousedown', function(e)
                                        {
                                            ...
                                            $(this).on('mousemove', function(e)
                                            {
                                                ...
                                                strMove.stop(true).css({ left: dragLeft })
                                            }).on('mouseup', function()
                                            {
                                                $(this).off('mousemove');
                                                if (p.inverthover)
                        ...
                        if (p.direction == 'up')
                        {
                            ...
                            if (strMove.height() > strWrap.height())
                            {
                                ...
                                if (p.xml)
                                {
                                    strMove.css({ top: strWrap.height() })
                                }
                                var k2 = 0;
                                timeFunc = function()
                                {
                                    ...
                                    if (p.drag)
                                    {
                                        strWrap.on('mousedown', function(e)
                                        {
                                            ...
                                            $(this).on('mousemove', function(e)
                                            {
                                                ...
                                                strMove.stop(true).css({ top: dragTop })
                                            }).on('mouseup', function()
                                            {
                                                if (p.inverthover)
                                                {
                        ...
                        if (p.direction == 'down')
                        {
                            ...
                            if (strMove.height() > strWrap.height())
                            {
                                ...
                                if (p.xml)
                                {
                                    strMove.css({ top: -strMove.height() })
                                }
                                var k2 = 0;
                                timeFunc = function()
                                {
